...
func (h *DataStoresHandler) Get(w http.ResponseWriter, r *http.Request, format string) ([]byte, error) {
...
func (h *DataStoresHandler) Post(w http.ResponseWriter, r *http.Request, format string) ([]byte, error) {
	...
	b, err := gss.SerializeBytes(map[string]interface{}{"success":true, "object": ds.Map()}, format, []string{}, gss.NoLimit)
	if err != nil {
		return b, errors.Wrap(err, "error serializing response body")
	}
	return b, nil
