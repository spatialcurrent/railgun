...
type HomeHandler struct {
	*BaseHandler
	CoconutAPI       string
	CoconutBaseLayer string
	CoconutBundle    string
}
...
func (h *HomeHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
  ...
  <head>
    ...
    <script>
      window.API_URL = "` + h.CoconutAPI + `";
      window.BASELAYER_URL = "` + h.CoconutBaseLayer + `";
    </script>
  </head>
  <body>
    <div id='app'></div>
  <script type="text/javascript" src="` + h.CoconutBundle + `"></script></body>
</html>
	`
...
func (h *HomeHandler) ServeHTTPOld(w http.ResponseWriter, r *http.Request) {
