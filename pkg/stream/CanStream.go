...
func CanStream(inputFormat string, outputFormat string, outputSorted bool) bool {
	...
	case serializer.FormatCSV, serializer.FormatTSV:
		switch outputFormat {
		case serializer.FormatCSV, serializer.FormatFmt, serializer.FormatJSONL, serializer.FormatGo, serializer.FormatGob, serializer.FormatTags, serializer.FormatTSV:
			return true
		}
