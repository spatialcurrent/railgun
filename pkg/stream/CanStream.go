...
func CanStream(inputFormat string, outputFormat string, outputSorted bool) bool {
	...
	case serializer.FormatCSV, serializer.FormatTSV:
		switch outputFormat {
		case serializer.FormatCSV, serializer.FormatTSV, serializer.FormatJSONL, serializer.FormatGo, serializer.FormatGob:
			return true
		}
	case serializer.FormatJSONL, serializer.FormatGob:
		switch outputFormat {
		case serializer.FormatJSONL, serializer.FormatGo, serializer.FormatGob:
			return true
		}
	}
